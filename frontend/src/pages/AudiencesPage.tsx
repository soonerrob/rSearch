    ...
    <div className="container mx-auto px-4 py-8 max-w-5xl">
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-2xl font-bold text-primary">Audience Management</h1>
        </div>
      ...
      <div className="bg-card-bg border border-card-border rounded-lg">
        <div className="border-b border-card-border p-4">
          <h2 className="text-lg font-semibold text-primary">Your Audiences</h2>
      ...
      <div className="mt-8 text-sm text-muted">
        <h3 className="font-medium text-primary mb-2">Tips:</h3>
